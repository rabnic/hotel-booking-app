          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    >
                      I accept the{" "}
                      <Link
                        className="font-medium text-orange-700 hover:underline dark:text-orange-500"
                        to=""
                      >
                ...
                <button
                  type="submit"
                  className="w-full text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  Create an account
                </button>
                <p className="text-sm font-light text-gray-600 dark:text-gray-400">
                  ...
                  <Link
                    to="/login"
                    className="font-medium text-orange-700 hover:underline dark:text-orange-700"
                  >
                    Login here
                  </Link>
                </p>
