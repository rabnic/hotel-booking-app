...
const Room = () => {
    ...
    const product = {
        ...
        reviews: 96,
        hrefReviews: "#link",
        description: "L61 x 2 bedroom apartments – Spacious two bedroom apartments have extra length beds with a choice of a king size or twin, ensuite bathrooms and a fully equipped kitchen, lounge and balcony.",
        features: [
    ...
    return (
        <main className='mt-24 flex justify-center items-center min-h-full border border-red-600'>
                ...
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:py-8 w-full lg:w-1/2 flex flex-col lg:border-l-2 border-gray-200">
                        ...
                        <div className="order-3 lg:order-1 pb-5 sm:px-6 lg:border-b-2 border-gray-200">
                            ...
                            <h4 className="text-lg mt-2 font-semibold dark:text-white">Room Amenities</h4>

                            <ul className="my-5 flex flex-wrap gap-3">
                                {product.features.map((feature, index) => (
                                    <li key={index} className="text-gray-500 w-fit list-disc list-inside">
                        ...
                        <div className="order-2 lg:order-3 pt-8 sm:px-6 flex flex-wrap lg:flex-nowrap justify-around items-center border-b-2 lg:border-none border-gray-200">
                            ...
                            {/* :::Add to cart button */}
                            <button type="button" className="m-2.5 py-1.5 px-5 inline-flex items-center rounded-md bg-orange-500 text-base text-white font-semibold uppercase whitespace-nowrap hover:bg-orange-600">
