...
function Home() {
  return (
    <main className="min-w-full  lg:w-3/4 mx-auto ">
      <section className="w-full  min-h-full border border-red-600">
        <div
        ...
        >
          <div className="absolute top-0 right-0 border border-green-600 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsla(0,0%,0%,0.75)] bg-fixed">
